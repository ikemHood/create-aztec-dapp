...
When contributing to `create-aztec-dapp`, whether on GitHub or in other community spaces:

- Be respectful, civil, and open-minded.
- Before opening a new pull request, try searching through the [issue tracker](https://github.com/ikemHood/create-aztec-dapp/issues) for known issues or fixes.
...
In order to not waste your time implementing a change that has already been declined, or is generally not needed, start by [opening an issue](https://github.com/ikemHood/create-aztec-dapp/issues/new/choose) describing the problem you would like to solve.

### Contributing via Codesandbox

You can contribute to this documentation on codesandbox which will automatically run all the setup command for you. [![Open with CodeSandbox](https://assets.codesandbox.io/github/button-edit-lime.svg)](https://codesandbox.io/p/github/ikemHood/create-aztec-dapp).
...
```bash
gh repo fork ikemHood/create-aztec-dapp
```

then, clone it to your local machine:

```bash
gh repo clone <your-github-name>/create-aztec-dapp
```
